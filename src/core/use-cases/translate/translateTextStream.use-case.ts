export const translateTexStreamUseCase = async(prompt:string, lang:string, abortSignal:AbortSignal) => {
    ...
    try {
        ...
        // De todo esto me interesa retornar el reader
        return reader;
        ...
        // Esto del while y del decoder va para otro lugar con Stream, con Generator van aqui
